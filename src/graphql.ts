...
export abstract class IQuery {
  abstract getAddress(
    id: string,
  ): Nullable<Address> | Promise<Nullable<Address>>;

  abstract getAddresses(): Address[] | Promise<Address[]>;

  abstract getOAuthAccount(
    id: string,
  ): Nullable<OAuthAccount> | Promise<Nullable<OAuthAccount>>;
  ...
  abstract getSession(
    id: string,
  ): Nullable<Session> | Promise<Nullable<Session>>;

  abstract getAllSessions(): Session[] | Promise<Session[]>;

  abstract getSocials(
    id: string,
  ): Nullable<Socials> | Promise<Nullable<Socials>>;
...
export abstract class IMutation {
  ...
  ): OAuthAccount | Promise<OAuthAccount>;

  abstract updateOAuthAccount(
    id: string,
    data: UpdateOAuthAccountInput,
  ): OAuthAccount | Promise<OAuthAccount>;
  ...
  abstract updateSocials(
    id: string,
    data: UpdateSocialsInput,
